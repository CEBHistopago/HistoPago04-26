...
export default function SignupRentalPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: 'Cuenta Creada',
        description: "Hemos creado tu cuenta para la gestión de alquileres.",
      });
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-background p-4">
      <Card className="mx-auto w-full max-sm border-2 border-primary/20">
        <CardHeader className="text-center">
          <div className="mb-4 flex items-center justify-center gap-2">
            <Logo className="h-16 w-auto" />
          </div>
          <CardTitle className="text-2xl">Registro HistoAlquiler</CardTitle>
          <CardDescription>
            Crea tu cuenta para gestionar tus contratos de arrendamiento.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSignup}>
            <div className="grid gap-4">
              <div className="grid gap-2">
                <Label htmlFor="full-name">Nombre Inmobiliaria o Arrendador</Label>
                <Input
                  id="full-name"
                  placeholder="John Doe / Inmuebles Express"
                  required
                  value={fullName}
              ...
              <Button type="submit" className="w-full" disabled={loading || !agreed}>
                ...
                Crear cuenta HistoAlquiler
              </Button>
            </div>
          </form>
           <div className="mt-4 text-center text-sm">
            ¿Eres un comercio tradicional?{' '}
